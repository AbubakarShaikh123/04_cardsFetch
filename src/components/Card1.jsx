...
function Card1({imgurl,title,des}) {
  return (
    <div className='w-[250px] h-[320px] bg-transparent rounded-sm border shadow-md shadow-white	cursor-pointer hover:scale-105 transition-all overflow-hidden text-ellipsis'>
